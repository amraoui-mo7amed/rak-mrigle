...
## Project Overview
Rak-Mrigle is a specialized marketplace connecting customers with transport and heavy machinery providers. It features a distance/hourly pricing engine, multi-role workflows (Admin, Customer, Provider), and a commission settlement system. The platform is mobile-first and supports Arabic (RTL), French, and English.
...
accounts/           # RBAC, KYC, and Profile management
catalog/            # Categories, Vehicles, and Service listings
orders/             # Request flow, Pricing engine, and History
payments/           # Commission ledger and Payout tracking
notifications/      # Real-time SSE notifications
```

**Key Patterns**
- Distance & Hourly Pricing Engine
- KYC Verification Workflow (Admin approval)
- AJAX/HTMX-driven interactions
