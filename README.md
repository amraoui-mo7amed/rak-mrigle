# Rak-Mrigle Marketplace

A specialized marketplace platform connecting customers with transport (trucks, utilities) and heavy machinery (cranes, loaders) providers. Built with a focus on reliability, distance-based pricing, and seamless multi-role workflows.
...
- **Frontend**: HTML5, CSS3, Vanilla JS, Bootstrap 5.3, HTMX
- **Icons**: FontAwesome 6
- **Real-time**: Django EventStream + SSE
- **Localization**: Django i18n (AR/FR/EN)
